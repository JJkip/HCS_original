...
<?php echo form_open("hcs_tab_upload/update_events"); ?>

<label for="title">Event</label>
<?php echo form_input(textInputBuilder("event_name", @$form['event_name'])); ?>

<label for="title">Venue</label>
<?php echo form_input(textInputBuilder("event_venue",  @$form["event_venue"])); ?>
