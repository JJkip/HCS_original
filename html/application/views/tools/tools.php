...
<div class="twelvecol">
    <div class="dropdown_section">
        ...
        <div class="drop_down">
            <?php
            $js = 'id="organization"';
            echo form_dropdown("organizations", $organizations, $org_id, $js);
            ?>
        </div>
    </div>
    ...
    <?php
            for ($i = 0; $i < count($org_tools); $i++):
                $current_doc = $org_tools[$i];
            ...
            <script type="text/javascript">// <![CDATA[
                $(document).ready(function(){
                    $('#organization').change(function(){ //any select change on the dropdown with organization trigger this code
                        ...
                        window.location.replace("<?php echo base_url() ?>index.php/tools/filter/"+org_id);
        });
    });
    // ]]>
</script>