...
class Cizacl extends CI_Controller	{
	...
	public function index()	{
        ...
        $this->template->load('admin', 'cizacl/main', $data);
	...
	{
		 $this->template->load('admin', 'cizacl/users', $data=null);
	...
	public function sessions()
	{
		 ...
		 $this->template->load('admin', 'cizacl/sessions', $data =null);
	}
	...
	public function management()
	{
		...
		$this->template->load('admin', 'cizacl/management', $data=null);
	}
